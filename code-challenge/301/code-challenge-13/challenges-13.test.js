...
const standardizePhoneNumbers = (arr) => {
  let stanPhoneNumberArr = [];
  arr.forEach(el => {
    stanPhoneNumberArr.push(`${el.substring(1, 4)}${el.substring(6,9)}${el.substring(10,14)}`)
  });
  return stanPhoneNumberArr;
};
